...
router.get('/all', async (req, res) => {
    ...
    const autosInfraçao = await tables.getTableGeneric(tables.tableNames.autosInfra, 'autoifr_id, num_infra, situaçao_auto, licen_id, processo_id, notificaçao_id');
    ...
    const oficios = await tables.getTableGeneric(tables.tableNames.oficios, 'oficio_id, num_oficio, link_oficio');
