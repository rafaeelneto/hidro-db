...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_custom_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../scss/custom.scss */ \"./public/scss/custom.scss\");\n/* harmony import */ var _scss_custom_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_custom_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _views_Base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/Base */ \"./public/js/views/Base.js\");\n/* harmony import */ var _models_User__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/User */ \"./public/js/models/User.js\");\n/* harmony import */ var _views_mapView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/mapView */ \"./public/js/views/mapView.js\");\n/* harmony import */ var _models_GisData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/GisData */ \"./public/js/models/GisData.js\");\n/* harmony import */ var _requests__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./requests */ \"./public/js/requests.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n\n/**\r\n * ------------------------\r\n * Event Listeners\r\n * ------------------------\r\n*/\n//Set Sidebar-right Event Listeners\n\n_views_Base__WEBPACK_IMPORTED_MODULE_1__[\"sidebarBtnID\"].addEventListener('click', function () {\n  _views_Base__WEBPACK_IMPORTED_MODULE_1__[\"sidebarID\"].classList.toggle('active');\n  _views_Base__WEBPACK_IMPORTED_MODULE_1__[\"contentClass\"].classList.toggle('active');\n  _views_Base__WEBPACK_IMPORTED_MODULE_1__[\"omniboxClass\"].classList.toggle('active');\n  _views_Base__WEBPACK_IMPORTED_MODULE_1__[\"sidebarBtnID\"].classList.toggle('actived');\n}); //Initialize the user and set hello msg\n\nvar user = new _models_User__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n\n_asyncToGenerator(\n/*#__PURE__*/\nregeneratorRuntime.mark(function _callee() {\n  var name;\n  return regeneratorRuntime.wrap(function _callee$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          _context.next = 2;\n          return user.getUser();\n\n        case 2:\n          name = _context.sent;\n          _views_Base__WEBPACK_IMPORTED_MODULE_1__[\"userNameID\"].innerHTML = name;\n\n          if (name === 'visitante') {\n            _views_Base__WEBPACK_IMPORTED_MODULE_1__[\"logoutBtnClass\"].innerHTML = 'Entrar';\n          }\n\n        case 5:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _callee);\n}))();\n/**\r\n * ------------------------\r\n * Map settings\r\n * ------------------------\r\n*/\n\n\nvar gisData = new _models_GisData__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n_views_mapView__WEBPACK_IMPORTED_MODULE_3__[\"initMap\"]();\n\nfunction getInfo(_x, _x2) {\n  return _getInfo.apply(this, arguments);\n}\n\nfunction _getInfo() {\n  _getInfo = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee3(type, id) {\n    var infoRes;\n    return regeneratorRuntime.wrap(function _callee3$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            _context3.next = 2;\n            return _requests__WEBPACK_IMPORTED_MODULE_5__[\"loadInfo\"](_requests__WEBPACK_IMPORTED_MODULE_5__[\"dashboardBase\"], _requests__WEBPACK_IMPORTED_MODULE_5__[\"gisURL\"] + '/cap', \"?id=\".concat(id, \"&type=\").concat(type));\n\n          case 2:\n            infoRes = _context3.sent;\n            console.log(infoRes);\n\n          case 4:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _callee3);\n  }));\n  return _getInfo.apply(this, arguments);\n}\n\nfunction clickPointListener(feature, layer) {\n  layer.on({\n    click: function click(e) {\n      var latLngs = [e.target.getLatLng()];\n      var markerBounds = L.latLngBounds(latLngs);\n      _views_mapView__WEBPACK_IMPORTED_MODULE_3__[\"map\"].fitBounds(markerBounds, {\n        maxZoom: 20\n      });\n      var s = feature.properties;\n      var keys = [];\n      var values = [];\n\n      for (var i in s) {\n        keys.push(i);\n        values.push(s[i]);\n      }\n\n      getInfo(keys[0], values[0]);\n    }\n  });\n}\n\n_asyncToGenerator(\n/*#__PURE__*/\nregeneratorRuntime.mark(function _callee2() {\n  var gisResults;\n  return regeneratorRuntime.wrap(function _callee2$(_context2) {\n    while (1) {\n      switch (_context2.prev = _context2.next) {\n        case 0:\n          _context2.next = 2;\n          return gisData.loadAll('cap');\n\n        case 2:\n          gisResults = _context2.sent;\n          console.log(gisResults);\n          poçosLayer = _views_mapView__WEBPACK_IMPORTED_MODULE_3__[\"loadPointLayer\"]('poço', gisResults[0], clickPointListener, _views_mapView__WEBPACK_IMPORTED_MODULE_3__[\"stylePoços\"]);\n          superfLayer = _views_mapView__WEBPACK_IMPORTED_MODULE_3__[\"loadPointLayer\"]('superf', gisResults[1], clickPointListener, _views_mapView__WEBPACK_IMPORTED_MODULE_3__[\"stylePoços\"]);\n\n        case 6:\n        case \"end\":\n          return _context2.stop();\n      }\n    }\n  }, _callee2);\n}))();\n\n//# sourceURL=webpack:///./public/js/main.js?");

/***/ }),

/***/ "./public/js/models/GisData.js":
/*!*************************************!*\
  !*** ./public/js/models/GisData.js ***!
  \*************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return GisData; });\n/* harmony import */ var _requests__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../requests */ \"./public/js/requests.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar GisData =\n/*#__PURE__*/\nfunction () {\n  function GisData() {\n    _classCallCheck(this, GisData);\n  }\n\n  _createClass(GisData, [{\n    key: \"loadAll\",\n    value: function () {\n      var _loadAll = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee(query) {\n        var gisRes;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.next = 2;\n                return _requests__WEBPACK_IMPORTED_MODULE_0__[\"makeSimpleGetRequest\"](_requests__WEBPACK_IMPORTED_MODULE_0__[\"dashboardBase\"], \"/gis/\".concat(query));\n\n              case 2:\n                gisRes = _context.sent;\n                return _context.abrupt(\"return\", gisRes);\n\n              case 4:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      function loadAll(_x) {\n        return _loadAll.apply(this, arguments);\n      }\n\n      return loadAll;\n    }()\n  }]);\n\n  return GisData;\n}();\n\n\n\n//# sourceURL=webpack:///./public/js/models/GisData.js?");
...
/*!*********************************!*\
  !*** ./public/js/views/Base.js ***!
  \*********************************/
/*! exports provided: sidebarID, contentClass, omniboxClass, sidebarBtnID, userNameID, logoutBtnClass, mapID */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"sidebarID\", function() { return sidebarID; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"contentClass\", function() { return contentClass; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"omniboxClass\", function() { return omniboxClass; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"sidebarBtnID\", function() { return sidebarBtnID; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"userNameID\", function() { return userNameID; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"logoutBtnClass\", function() { return logoutBtnClass; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"mapID\", function() { return mapID; });\nvar sidebarID = document.querySelector('#sidebar');\nvar contentClass = document.querySelector('.content');\nvar omniboxClass = document.querySelector('.omnibox');\nvar sidebarBtnID = document.querySelector('#sidebarCollapse');\nvar userNameID = document.querySelector('#user-name');\nvar logoutBtnClass = document.querySelector('#btn-logout');\nvar mapID = document.getElementById('map');\n\n//# sourceURL=webpack:///./public/js/views/Base.js?");
